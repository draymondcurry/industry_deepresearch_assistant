          ...
          <div className={styles['brand-content']}>
            <div className={styles['brand-icon']}>
              <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M24 4L4 14V34L24 44L44 34V14L24 4Z" stroke="url(#logoGrad)" strokeWidth="1.5" strokeLinejoin="round"/>
                <path d="M24 4V24M24 24L4 14M24 24L44 14M24 24V44" stroke="url(#logoGrad)" strokeWidth="1.5" strokeLinejoin="round"/>
              </svg>
            </div>
            <h1 className={styles['brand-title']}>DeepResearch</h1>
            <p className={styles['brand-subtitle']}>行业研究助手</p>
