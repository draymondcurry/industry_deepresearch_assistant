...
import { FileTextOutlined, ShareAltOutlined, BarChartOutlined, CheckOutlined, LoadingOutlined, FileMarkdownOutlined, LeftOutlined } from '@ant-design/icons'
  ...
  return (
    <div className={styles.panel}>
      ...
      <div className={styles.panelHeader}>
        <span className={styles.panelTitle}>研究面板</span>
        <button className={styles.collapseBtn} onClick={onClose} title="收起面板">
