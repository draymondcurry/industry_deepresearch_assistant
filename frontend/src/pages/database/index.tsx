    ...
    <div style={{ background: colors.bg, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', borderBottom: `1px solid ${colors.border}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <Tag style={{ margin: 0, background: colors.active, border: 'none', color: colors.textSecondary, fontSize: 11 }}>PostgreSQL</Tag>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <Input
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: 24 }}>
          ...
          {(searchLoading || searchResult) && (
            <div style={{ marginBottom: 24, border: `1px solid ${colors.border}`, borderRadius: 8, overflow: 'hidden' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: colors.hover, borderBottom: `1px solid ${colors.border}` }}>
              ...
              {searchLoading ? (
                ...
                <div>
                  {/* SQL */}
                  {searchResult.sql && (
                    <div style={{ padding: '12px 16px', borderBottom: `1px solid ${colors.border}`, background: colors.hover }}>
                  ...
                  {searchResult.success && searchResult.data && searchResult.data.length > 0 ? (
                    <div style={{ overflowX: 'auto' }}>
                      <div style={{ display: 'flex', minWidth: (searchResult.columns?.length || 1) * 150, background: colors.hover, borderBottom: `1px solid ${colors.border}` }}>
                      ...
                      <div style={{ padding: '10px 16px', fontSize: 12, color: colors.textTertiary, background: colors.hover }}>
              ...
              {dataLoading ? (
                ...
                <>
                  <div style={{ border: `1px solid ${colors.border}`, borderRadius: 8, overflow: 'hidden' }}>
                    {/* 表头 */}
                    <div style={{ overflowX: 'auto' }}>
                      <div style={{ display: 'flex', minWidth: tableColumns.length * 150, background: colors.hover, borderBottom: `1px solid ${colors.border}` }}>
